      ...
      {() => {
        return (
          <div className="complete">
            <h4 className="text-black font-medium text-lg"> Finished Task</h4>
              ...
              {todoStore.todoList
                ...
                .map((el) => {
                  ...
                  return (
                    <li
                      key={id}
                      className="w-fit px-10 py-2 bg-blue-500 text-white rounded-lg flex flex-col gap-2 items-center"
                    >
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          onClick={() => todoStore.incomplete(id)}
                        >
                          Undo
                        </button>
                        <button
